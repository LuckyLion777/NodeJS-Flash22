...
gulp.task('index_libs_copy', () => {
  return gulp.src([
    `${config.src}/scripts/libs/index.libs.js`,
  ])
    .pipe(uglify())
...
gulp.task('copy-css-libs', () => {
  return gulp.src([
    `${config.src}/styles/libs.min.css`,
  ])
...
gulp.task('compile-sass-and-copy', () => {
  ...
  return gulp.src(`${config.src}/styles/style.scss`)
    .pipe(debug({ title: 'Compiling sass this file:' }))
...
gulp.task('stripcss', () => {
  return gulp.src(`${config.dist}/assets/temp/**/*.css`)
    .pipe(debug({ title: 'Strip css this file:' }))
...
gulp.task('csspurify', () => {
  return gulp.src(`${config.dist}/assets/temp/**/*.css`)
    ...
    .pipe(debug({ title: 'CSS purify this file:' }))
...
gulp.task('autoprefix', () => {
  return gulp.src(`${config.dist}/assets/css/style.css`)
    .pipe(debug({ title: 'CSS autoprefix purify this file:' }))
    .pipe(autoprefixer({
