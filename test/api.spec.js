...
describe('security headers send by nodejs application', () => {
  ...
  it('have Access-Control-Allow-Methods set to "*"', (done) => {
    supertest(app)
      .get('/tacticalsales/')
      .expect('X-Powered-By', 'TacticalMastery')
...
//        process.exit(1);
  ...
  it.skip('has 403 for /api/v2/ping with wrong entry point', (done) => {
    supertest(app)
      .get('/tacticalsales/api/v2/ping')
      .expect('X-Powered-By', 'TacticalMastery')
...
// https://starlightgroup.atlassian.net/browse/SG-5
    ...
    it.skip('sets proper data for /api/v2/testSession WITHOUT session token provided', (done) => {
      supertest(app)
        .get('/tacticalsales/api/v2/testSession')
        .expect('X-Powered-By', 'TacticalMastery')
        .expect('X-PUNISHEDBY', 'BAD LOCATION')
  ...
  describe('/tacticalsales/api/v2/add-contact', () => {
    ...
    it.skip('has 403 on POST /api/v2/add-contact with bad entry point', (done) => {
      supertest(app)
        .post('/tacticalsales/api/v2/add-contact')
...
// Only check API call
  ...
  describe('/tacticalsales/api/v2/create-lead', () => {
    ...
    it.skip('has 403 on POST /api/v2/create-lead with wrong entryPoint', (done) => {
      supertest(app)
        .post('/tacticalsales/api/v2/create-lead')
        .set('Cookie', [util.format('PHPSESSID=%s', taintedSessionId)])
        .expect('X-PUNISHEDBY', 'BAD LOCATION')
  ...
  describe('/tacticalsales/api/v2/create-order', () => {
    ...
    it.skip('has 403 on POST /api/v2/create-order with wrong entryPoint', (done) => {
      supertest(app)
        .post('/tacticalsales/api/v2/create-order')
        .set('Cookie', [util.format('PHPSESSID=%s', taintedSessionId)])
        .send({
  ...
  describe('/tacticalsales/api/v2/upsell', () => {
    ...
    it.skip('has 403 on POST /api/v2/create-upsell with wrong entryPoint', (done) => {
      supertest(app)
        .post('/tacticalsales/api/v2/create-upsell')
        .set('Cookie', [util.format('PHPSESSID=%s', taintedSessionId)])
        .send({
